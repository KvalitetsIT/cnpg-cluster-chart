...
release:
	...
	yq -i ".version = \"$(VERSION)\"" charts/cnpg-cluster/Chart.yaml
	yq -i ".appVersion = \"$(VERSION)\"" charts/cnpg-cluster/Chart.yaml
	$(MAKE) docs
	git add charts/cnpg-cluster/Chart.yaml charts/cnpg-cluster/README.md
